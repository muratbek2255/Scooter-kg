...
class PayboxWallet(models.Model):
    owner = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="paybox_wallet", verbose_name='paybox_wallet'
    )
...
class Transaction(models.Model):
    ...
    wallet = models.ForeignKey(
        PayboxWallet, related_name='paybox_transactions', on_delete=models.CASCADE, verbose_name='paybox_wallet'
    )
