    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_network', models.URLField(blank=True, default='email', null=True, verbose_name='Социальная сеть')),
                ('is_verifed', models.BooleanField(default=False, verbose_name='Прошел верикацию')),
